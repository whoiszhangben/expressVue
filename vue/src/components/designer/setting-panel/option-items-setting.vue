<template>
  <div class="option-items-pane">
    ...
    <div v-if="(selectedWidget.type === 'cascader')">
      <el-button type="text" @click="importCascaderOptions">导入项</el-button>
      <el-button type="text" @click="resetDefault">重置</el-button>
    </div>
    ...
    <div v-if="(selectedWidget.type === 'radio') || (selectedWidget.type === 'checkbox') || (selectedWidget.type === 'select')">
      ...
      <el-button type="text" @click="importOptions">导入项</el-button>
      <el-button type="text" @click="resetDefault">重置</el-button>
    </div>

    <el-dialog title="导入选项" :visible.sync="showImportDialogFlag"
    ...
    <el-dialog title="导入选项" :visible.sync="showImportCascaderDialogFlag"
  ...
  export default {
    ...
    watch: {
      'selectedWidget.options': {
        deep: true,
        handler(val) {
          console.log('888888', 'Options change!', val)
        }
      },
    },
    methods: {
