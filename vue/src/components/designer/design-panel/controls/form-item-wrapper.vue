...
.el-form-item span.custom-label i {
  margin: 0 3px;
}

.el-form-item ::v-deep .hide-spin-button input::-webkit-outer-spin-button,
.el-form-item ::v-deep .hide-spin-button input::-webkit-inner-spin-button {
  -webkit-appearance: none !important;
}

.el-form-item ::v-deep .hide-spin-button input[type="number"] {
