...
<script>
  ...
  import TableCellWidget from "@/components/designer/design-panel/containers/table-cell-widget"
...
div.table-container table.table-layout ::v-deep td {
  height: 48px;
  border: 1px dashed #336699;
  padding: 3px;
  display: table-cell;
...
div.table-container table.table-layout .form-widget-list {
  border: 1px dashed #336699;
  min-height: 36px;
}
